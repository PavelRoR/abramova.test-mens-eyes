...
<html lang="ru">
  <head>
    ...
    <meta property="og:title" content="Что для вас важнее всего в отношениях?"/>
    <meta property="og:description" content="4 вопрос теста"/>
    <title>«Что для вас важнее всего в отношениях?» 4 вопрос теста</title>
...
<!-- Rating@Mail.ru counter -->
    ...
    <section class="main main-question main-question-4">
      <div class="container">
        <h1 class="question-title">Вопрос 4</h1>
        <h2 class="question-subtitle">Что для вас важнее всего в отношениях?</h2>
      </div>
    </section>
    <section class="second">
      <div class="container">
        <form class="question-form" action="end.php" method="POST">
          <div class="choice">
            <input class="q-radio" type="radio" name="question-4" id="q-choice-0" value="0" checked />
            <label for="q-choice-0">Уверенность в завтрашнем дне, надежность, домашний уют</label>
          </div>
          <div class="choice">
            <input class="q-radio" type="radio" name="question-4" id="q-choice-1" value="1"/>
            <label for="q-choice-1">Яркие эмоции, интересное общение, сумасшедший секс</label>
          </div>
          <div class="choice">
            <input class="q-radio" type="radio" name="question-4" id="q-choice-2" value="2"/>
            <label for="q-choice-2">Семейный статус, дети, совместные праздники и поездки</label>
          </div>
          <div class="choice">
            <input class="q-radio" type="radio" name="question-4" id="q-choice-3" value="3"/>
            <label for="q-choice-3">Взаимное понимание, общность интересов, духовное развитие</label>
          </div>
          <div class="choice">
            <input class="q-radio" type="radio" name="question-4" id="q-choice-4" value="4"/>
            <label for="q-choice-4">Поддержка, забота, помощь</label>
          </div>
          <div class="choice">
            <input class="q-radio" type="radio" name="question-4" id="q-choice-5" value="5"/>
...
?>
                ...
                <input type="hidden" name="question-3" value="<?=$answer3?>" />
